...
public class BlockRockUnconsolidatedBoulder extends BlockMetaFalling
{
    ...
    public BlockRockUnconsolidatedBoulder()
    {
        super(BlockTypes.RockUnconsolidatedTypes.class, TYPE, Material.SAND);
    ...
    {
        return ((BlockTypes.RockUnconsolidatedTypes) state.getValue(type)).getHardness() / 4.0f;
    }

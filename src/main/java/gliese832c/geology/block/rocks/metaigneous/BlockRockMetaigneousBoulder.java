package gliese832c.geology.block.rocks.metaigneous;
...
public class BlockRockMetaigneousBoulder extends BlockMetaFalling
{
    ...
    {
        super(BlockTypes.RockMetaigneousTypes.class, TYPE, Material.SAND);
    ...
    {
        return ((BlockTypes.RockMetaigneousTypes) state.getValue(type)).getHardness() / 4.0f;
    }

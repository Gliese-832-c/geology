package gliese832c.geology.block.rocks.plutonic;
...
public class BlockRockPlutonicRocks extends BlockMetaFalling
{
    ...
    public BlockRockPlutonicRocks()
    {
        super(BlockTypes.RockPlutonicTypes.class, TYPE, Material.SAND);
    ...
    {
        // return ((BlockTypes.RockPlutonicTypes) state.getValue(type)).getHardness();
        return 0.5f;
    }
    ...
    {
        // return ((BlockTypes.RockPlutonicTypes) state.getValue(type)).getHarvestTool();
        return null;
    }

    public int getHarvestLevel(IBlockState state)
    {
        // return ((BlockTypes.RockPlutonicTypes) state.getValue(type)).getHarvestLevel();
        return -1;
    }
    ...
    {
        return ((BlockTypes.RockPlutonicTypes) state.getValue(type)).getID();
    }
    ...
    {
        return new ItemStack(Item.getItemFromBlock(this), 1, ((BlockTypes.RockPlutonicTypes) state.getValue(type)).getID());
    }

package gliese832c.geology.block.rocks.metasedimentary;
...
public class BlockRockMetasedimentaryBoulder extends BlockMetaFalling
{
    ...
    public BlockRockMetasedimentaryBoulder()
    {
        super(BlockTypes.RockMetasedimentaryTypes.class, TYPE, Material.SAND);
    ...
    {
        return ((BlockTypes.RockMetasedimentaryTypes) state.getValue(type)).getHardness() / 4.0f;
    }

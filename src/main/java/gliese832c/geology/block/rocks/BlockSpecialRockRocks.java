...
public class BlockSpecialRockRocks extends BlockMetaFalling
{
    public final static PropertyEnum TYPE = PropertyEnum.create("type", BlockTypes.SpecialRockRocks.class);
    private static final AxisAlignedBB ROCKS_AABB = new AxisAlignedBB(1.0 / 16.0, 0.0 / 16.0, 1.0 / 16.0, 15.0 / 16.0, 2.0 / 16.0, 15.0 / 16.0);

    public BlockSpecialRockRocks()
    {
        super(BlockTypes.SpecialRockRocks.class, TYPE, Material.SAND);
    ...
    {
        // return ((BlockTypes.SpecialRockRocks) state.getValue(type)).getHardness();
        return 0.5f;
    }
    ...
    {
        // return ((BlockTypes.SpecialRockRocks) state.getValue(type)).getHarvestTool();
        return null;
    }

    public int getHarvestLevel(IBlockState state)
    {
        // return ((BlockTypes.SpecialRockRocks) state.getValue(type)).getHarvestLevel();
        return -1;
    }
    ...
    {
        return ((BlockTypes.SpecialRockRocks) state.getValue(type)).getID();
    }
    ...
    {
        return new ItemStack(Item.getItemFromBlock(this), 1, ((BlockTypes.SpecialRockRocks) state.getValue(type)).getID());
    }
